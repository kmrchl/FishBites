...
<head>
    ...
    <title>Fish Bites - Edit Article</title>
                ...
                <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                    ...
                    <div class="row tm-edit-product-row">
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <form action="{{ route('artikel.update', $artikel->id_artikel) }}" method="POST" enctype="multipart/form-data" class="tm-edit-product-form">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input id="judul" name="judul" type="text" class="form-control validate" value="{{ old('judul', $artikel->judul) }}" required>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="datetime-local" id="tgl_upload" name="tgl_upload" class="form-control" value="{{ old('tgl_upload', $artikel->tgl_upload) }}" required>
                                </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
                            ...
                            <div class="custom-file mt-3 mb-3">
                                ...
                                <input type="button" class="btn btn-primary btn-block mx-auto" value="CHANGE ARTICLE IMAGE" onclick="document.getElementById('fileInput').click();">
                            </div>
                        </div>

                        <div class="col-12">
                            <button type="submit" class="btn btn-primary btn-block text-uppercase">Edit Artikel</button>
                        </div>
