  ...
  <html lang="en">
    <head>
      ...
      <title>Fish Bites - Add Produsen</title>
      <link
        rel="stylesheet"
        ...
        <div class="row">
          <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
            <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
              <div class="row">
                <div class="col-12">
                  <h2 class="tm-block-title d-inline-block">Tambah Produsen</h2>
                </div>
              </div>
              <div class="row tm-edit-product-row">
                  <div class="col-12">
                    <form method="POST" action="/api/addprodusem" class="tm-edit-product-form">
                      @csrf
                      <div class="form-group mb-3">
                        <label for="nama_produsen">Produsen</label>
                        <textarea class="form-control validate" rows="1" id="nama_produsen" name="nama_produsen" required></textarea>
                      </div>
                      <div class="form-group mb-3">
                        <label for="lokasi">Lokasi</label>
                        <textarea class="form-control validate" rows="2" id="lokasi" name="lokasi" required></textarea>
                      </div>
                      <div class="form-group mb-3">
                        <button type="submit" class="btn btn-primary btn-block text-uppercase">Tambah Produsen</button>
                      </div>
                    </form>
                  </div>
                </div>
