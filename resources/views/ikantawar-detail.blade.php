...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Iodium | Iodium- minimal onepage personal/portofolio Template. It is built using bootstrap 3.3.2 framework, works totally responsive, easy to customise, well commented codes and seo friendly.">
...
<body>
	...
	<div class="navbar navbar-default main-menu">
      ...
      <div class="container">
		...
		<ul class="nav navbar-nav navbar-right">
			 <li  rel="home" ><a href="{{ url('/index') }}">HOME</a></li>
			 <li  rel="about"><a href="{{ url('/index#about') }}">ABOUT US</a></li>
			 <li  rel="team" ><a href="{{ url('/index#product') }}">PRODUCT</a></li>
			 <li  rel="news" ><a href="{{ url('/index#blog') }}">NEWS</a></li>
			 <li  rel="testimonials" ><a href="{{ url('/index#testimony') }}">TESTIMONIALS</a></li>
			 <li  rel="contact" ><a href="{{ url('/index#contact') }}">CONTACT</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </div>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="pull-left">
						<div class="title">
							<h1 class="lead wow fadeInDown">IKAN AIR TAWAR</h1>
					...
					<div class="pull-right">
						<ol class="breadcrumb text-right">
                            ...
                            <li><a href="/ikantawar">Product</a></li>
	...
	<!-- BLOG SECTION -->
	<div id="blog" class="section blog" data-slide="5">
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-8">
								<div class="item-body">
									...
									<p>Gurame adalah ikan air tawar berkualitas tinggi yang ditangkap langsung oleh petani lokal dari perairan bersih di pedesaan. Ikan ini dikenal akan dagingnya yang lembut dan lezat, dengan tekstur yang cocok untuk berbagai hidangan khas Indonesia.</p>
									<p>Kondisi dan Spesifikasi :
										1. Gurame fresh frozen, siap dimasak
										2. Ukuran/Berat: 1 kg utuh per ekor
										3. Sudah bersih dari sisik dan isi perut, siap diolah</p>
								</div>
							</div>
						</div>
					</div>
