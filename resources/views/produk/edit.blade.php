        ...
        <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
          ...
          <div class="row tm-edit-product-row">
            <div class="col-xl-6 col-lg-6 col-md-12">
              ...
              <form action="{{ route('produk.update', $produk->id_produk) }}" method="POST" class="tm-edit-product-form">
                @csrf
                @method('PUT')
                ...
                <div class="form-group mb-3">
                  ...
                  <select name="id_admin" id="id_admin" class="custom-select tm-select-accounts" required>
                ...
                <div class="form-group mb-3">
                  ...
                  <select name="id_produsen" id="id_produsen" class="custom-select tm-select-accounts" required>
                    @foreach ($produsens as $produsen)
                      <option value="{{ $produsen->id_produsen }}" {{ $produk->id_produsen == $produsen->id_produsen ? 'selected' : '' }}>
                ...
                <div class="col-12">
                  <button type="submit" class="btn btn-primary btn-block text-uppercase">Edit Produk</button>
                </div>
              </form>
            </div>
