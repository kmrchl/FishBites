        ...
        <div class="row tm-content-row justify-content-center">
            <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 tm-block-col">
                <div class="tm-bg-primary-dark tm-block tm-block-products">
                            ...
                            <tbody>
                                @foreach ($show as $produk)
                                    <tr>
                                        ...
                                        <td>
                                        <td>
                                            <a href="{{ route('produk.edit', $produk->id_produk) }}" class="btn btn-primary btn-sm">Edit</a>
                                            <form method="POST" action="{{ url('/api/hapusproduk/' . $produk->id_produk) }}" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <a href="{{ route('produk.add') }}" class="btn btn-primary btn-block text-uppercase mb-3">Tambah Produk</a>
                </div>
            </div>
        </div>
    </div>
