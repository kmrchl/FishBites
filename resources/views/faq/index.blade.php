      ...
      <div class="row tm-content-row justify-content-center">
        <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 tm-block-col">
          <div class="tm-bg-primary-dark tm-block tm-block-products">
                ...
                <tbody>
                  @foreach($faqs as $faq)
                    <tr>
                      ...
                      <td>{{ $faq->timestamp }}</td>
                      <td>
                        <a href="{{ route('faq.edit', $faq->id_faq) }}" class="btn btn-primary btn-sm">Edit</a>
                      </td>
                    </tr>
                  @endforeach
                </tbody>
            ...
            <a href="{{ route('faq.add') }}" class="btn btn-primary btn-block text-uppercase mb-3">Tambah FAQ</a>
            @csrf 
            @method('DELETE')
            <button class="btn btn-primary btn-block text-uppercase">Hapus FAQ</button>
          </div>
        </div>
      </div>
    </div>
