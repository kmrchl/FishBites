    ...
    <body>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4"> <!-- Item Team #2 -->
                                <div class="team-item wow fadeInDown">
                                    ...
                                    <div class="item-body">
                                        <h2><a href="/ikantawar/2">IKAN AIR TAWAR SEGAR</a></h2>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="row">
                            @foreach ($artikel as $item)
                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="arikel"> <!-- Item Blog #1 -->
                ...
                <div class="row">
                    <div class="element-content">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                            <br />
                            <a href="#" title=""
                                class="btn btn-primary btn-lg pull-right fadeInDown">Download
                                Now</a>
                        </div>
        ...
        {{-- <script>
            $(document).ready(function() {
                // URL API
                const apiURL = "{{ url('/api/artikel') }}";

                // Request AJAX untuk mengambil data produk
                $.ajax({
                    url: apiURL,
                    type: 'GET',
                            ...
                            $('#artikel').append(`
                                <div class="blog-item wow fadeInDown">
                                    <div class="gambar">
                                        ...
                                        <img src="{{ asset('storage/') }}/${artikel.gambar}" alt="${artikel.judul}" class="img-responsive" />
                                    </div>
                                    <div class="item-body">
                                        <p class="lead">
                                        ...
                                        <p>${artikel.konten}</p>
                                        <p>
                                            <a href="{{ url('/blog-detail') }}/${artikel.id_artikel}" title="" class="readmore">Read More</a>
                                        </p>
                                    </div>
                                </div>
                            `);
                    ...
                    error: function(xhr, status, error) {
                        ...
                        $('#artikel').html(
                            '<p style="color:red;">Gagal memuat artikel. Silakan coba lagi nanti.</p>');
                    }
                });
            });
        </script> --}}
