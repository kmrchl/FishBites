...
@section('title', 'Bibit Pakan Detail')
                        ...
                        <div id="comments" class="comment">
                            ...
                            <div class="media comment-block"> <!-- Comment Block #1 -->
                                <div class="media-left media-top">
                                    <a href="#">
                                        <img class="media-object" src="assets/images/100px100.jpg" alt="..."
                                            width="100">
                                    </a>
                                </div>
                                <div class="media-body">
                                    <!-- <a href="#" class="pull-right text-uppercase">Reply</a> -->
                                    <h5 class="media-heading">Post by <a href="#">Adinda Rahma</a><small
                                            class="">Nov. 05, 2024</small></h5>
                    ...
                    <div class="row">
                        <div class="element-content">
                            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                ...
                                <p class="wow fadeInLeft">Unduh aplikasi kami sekarang dan nikmati ikan segar setiap hari!
                                </p>
                            </div>
                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                <br />
                                <a href="#" title=""
                                    class="btn btn-primary btn-lg pull-right fadeInDown">Download Now</a>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
